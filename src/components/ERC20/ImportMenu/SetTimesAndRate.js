...
const SetTimesAndRate = ({ web3Time, tokenAddress, refreshDataGrid }) => {
  ...
  const onClickTransfer = async () => {
    ...
    //   console.log(temp4, "temp4");
      ...
      await web3Time.methods
        .setTimesAndRate(data.arg3, temp1, temp4)
      ...
      <Grid item xs={12}>
        ...
        >
          {data.loading ? (
            ...
            "SetTimesAndRate(uint256 times_, uint256[] rate_, uint256[] timeLock_)"
          )}
        </Button>
      </Grid>
      <Grid item xs={12}>
...
export default SetTimesAndRate;
